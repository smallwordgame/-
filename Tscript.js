...
function count(){
    ...
    Mcount = (-1 * (MRcount - 2)) + (1 * (MYcount - 2)) + (3 * (MGcount - 2));
...
function setFigures(sectionId) {
    ...
    if (sectionId === "Mred") { FIGURES[0] = tempA; }
    if (sectionId === "Myellow") { FIGURES[1] = tempA; }
    if (sectionId === "Mgreen") { FIGURES[2] = tempA; }
    if (sectionId === "Gred") { FIGURES[3] = tempA; }
    if (sectionId === "Gyellow") { FIGURES[4] = tempA; }
    if (sectionId === "Ggreen") { FIGURES[5] = tempA; }
}

BredE.addEventListener("click", function(){
    EXPAND[0][1] = toggleBool(0, "BredE", EXPAND[0][1]);
    hide(EXPAND[0][0]);
});

ByellowE.addEventListener("click", function(){
    EXPAND[1][1] = toggleBool(1, "ByellowE", EXPAND[1][1]);
    hide(EXPAND[1][0]);
});

BgreenE.addEventListener("click", function(){
    EXPAND[2][1] = toggleBool(2, "BgreenE", EXPAND[2][1]);
    hide(EXPAND[2][0]);
});

RredE.addEventListener("click", function(){
    EXPAND[3][1] = toggleBool(3, "RredE", EXPAND[3][1]);
    hide(EXPAND[3][0]);
});

RyellowE.addEventListener("click", function(){
    EXPAND[4][1] = toggleBool(4, "RyellowE", EXPAND[4][1]);
    hide(EXPAND[4][0]);
});

RgreenE.addEventListener("click", function(){
    EXPAND[5][1] = toggleBool(5, "RgreenE", EXPAND[5][1]);
    hide(EXPAND[5][0]);
});
...
function findSection(location){
    if (location === "Mred") { return(0); }
    if (location === "Myellow") { return(1); }
    if (location === "Mgreen") { return(2); }
    if (location === "Gred") { return(3); }
    if (location === "Gyellow") { return(4); }
    if (location === "Ggreen") { return(5); }
}